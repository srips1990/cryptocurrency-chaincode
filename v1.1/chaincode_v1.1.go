...
func (t *SimpleChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	} else if function == "read_user_account_details" {													//read a variable
		return t.read_user_account_details(stub, args)
	}
...
// ============================================================================================================================
func (t *SimpleChaincode) read_user_account_details(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
